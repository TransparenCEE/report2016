...
var hideMenu = function(){
  ...
  $('.sections-container').fullpage({
      anchors: ['section-cover', 'section-intro', 'section-civic-tech', 'section-events', 'section-event-2', 'section-event-3', 'section-event-1', 'section-event-4', 'section-build', 'section-standards', 'section-data', 'section-practices', 'section-thankyou', 'section-bye'],
  ...
  $(document).on("click", ".main-navigation a", function(e){
    e.preventDefault();
    var thisHref = $(e.target).attr("data-goto");
  ...
  $(document).on("click", "a.event-link", function(e){
    e.preventDefault();

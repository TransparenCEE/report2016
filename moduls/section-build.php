<section id="section-build" class="section menu-section dark">
  <div class="content-column">
    <h2 class="slide-title">
      <span class="title-text">Building and scaling civic tech products</span>
    ...
    <div class="projects-container">
        ...
        <div class="project project-4">
          <h3 class="project-title">Faktograf (Croatia)</h3>
          <div class="project-links">
